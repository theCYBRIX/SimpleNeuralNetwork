...
public class ProcessInputsRequest<E extends SimpleNeuralNetwork> extends ContextualJsonRequestHandler<NetworkIDManager<E>> {
    ...
    public ResponsePacket handle(JsonObject request, NetworkIDManager<E> context) throws Exception {
        ...
        Map<Integer, double[]> outputs = context.processInputs(new Int2ObjectOpenHashMap<>(inputs));
