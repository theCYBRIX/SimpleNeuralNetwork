...
import com.github.thecybrix.simpleneuralnetwork.api.valuemapping.ValueMappingContext.State;
...
public class GetTrainingStateRequest<E extends MutableNeuralNetwork> extends ContextualJsonRequestHandler<ValueMappingContext<E>> {
