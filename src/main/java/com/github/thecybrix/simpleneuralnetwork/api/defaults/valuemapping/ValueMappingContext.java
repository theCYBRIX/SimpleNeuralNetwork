...
public class ValueMappingContext<E extends MutableNeuralNetwork> extends EvolutionContext<E> {
    ...
    public void approximateDataSet(TrainingDataSet dataSet) throws IllegalArgumentException, InterruptedException, ExecutionException, NullPointerException{
        ...
        ValueMappingTrainer<E> trainingScenario = ValueMappingTrainer.of(dataSet.inputs, dataSet.outputs, new ValueMappingTrainer.MeanSquaredError(), NETWORK_MANAGER.EXECUTOR_SERVICE);
        ...
        dataTrainedNetworks = NETWORK_MANAGER.EXECUTOR_SERVICE.submit(() -> {
            datasetTrainer.run();
