...
public class NeuralNetworkAdapter<E extends SimpleNeuralNetwork> extends TypeAdapter<E> {
    final private static String LAYOUT = "layout", WEIGHTS = "weights", BIASES = "biases";
    ...
    public E read(JsonReader in) throws IOException {
        ...
        try {
            ...
            NETWORK_BUILDER.withLayout(layout);
            NETWORK_BUILDER.withWeights(weights);
            NETWORK_BUILDER.withBiases(biases);
