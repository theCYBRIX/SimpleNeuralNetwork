    ...
    public static class NetworkLayer {
        ...
        public boolean equals(Object obj) {
            ...
            return (this.getNodeCount() == other.getNodeCount())
                && this.getActivationFunction().equals(other.getActivationFunction())
                && this.getInputNormalizer().equals(other.getInputNormalizer());
        }
        ...
        public String toString() {
            ...
            out.append(" (").append(INPUT_NORMALIZER).append(") ");
            out.append("(").append(ACTIVATION_FUNCTION).append(")");
