...
public abstract class AbstractJsonRequestHandler implements JsonRequestHandler {
    ...
    public AbstractJsonRequestHandler(String endpoint, Map<String, PropertyType> requiredProperties, Map<String, PropertyType> optionalProperties, Map<String, PropertyType> outputProperties) {
