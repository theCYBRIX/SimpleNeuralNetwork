...
@FunctionalInterface
public interface BiParentOffspringFunction<E extends SimpleNeuralNetwork> {
    public ScoredNetwork<E> createOffspring(ScoredNetwork<E> parent1, ScoredNetwork<E> parent2, double learningRate);
}
