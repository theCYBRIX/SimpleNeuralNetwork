...
public class Population<E extends RankedNeuralNetwork> {
    ...
    private Optional<Double> bestScore;
    ...
    private void updateNumParentNetworks() {
        ...
        if(currentGeneration.size() < numParentNetworks)
            currentGeneration.addAll(NeuralNetworkTools.getRandomizedNetworks(numParentNetworks - currentGeneration.size(), NETWORK_PROVIDER));
    }
